...
<div class="d-flex justify-content-beetwen">
  <div>
    <a class="btn btn-link" href="/bag" >
      <image src="{{ asset('images/bag.png') }}" tittle="bag" width="40%" height="100px"/><br>
      Túi
    </a>
  </div>
    <div> 
    <a class="btn btn-link" href="/bag" >
      <image src="{{ asset('images/farm.png') }}" tittle="bag" width="40%" height="100px"/><br>
      Cánh Đồng
    </a>
  </div>
  <div>
    <a class="btn btn-link" href="/bag" >
      <image class="mx-auto" src="{{ asset('images/pig.png') }}" tittle="bag" width="50%" height="100px"/><br>
      Vật Nuôi
    </a>
  </div>
  <div>
    <a class="btn btn-link" href="/bag" >
      <image  src="{{ asset('images/shop.png') }}" tittle="bag" width="50%" height="100px"/><br>
      Cửa Hàng
    </a>
  </div>
</div>
