...
@section('content')
     <a class="text-primary" href="{{ route('forum') }}">Forum</a>&nbsp/&nbsp<a class="text-primary" href="/forum/3">Trò chuyện</a>
    <div class="card bg-none mt-5 shadow">
      ...
      <div class="card-body" style="padding:0px 5px;">
        @guest
        @else
          <a class="btn btn-success float-right mx-3 mt-3" href="/forum/3/create">
            Tạo bài viết
          </a>
